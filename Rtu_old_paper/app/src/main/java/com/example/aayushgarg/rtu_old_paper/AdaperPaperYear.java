...
/**
 * Created by aayushgarg on 6/9/18.
 */

public class AdaperPaperYear  extends RecyclerView.Adapter<AdaperPaperYear.ViewHolder>  {
    private ProgressDialog progressDialog;
    private List<PaperTable> item;
    private Context context;
    private MyFunction myFunction;

    public AdaperPaperYear(List<PaperTable> item, Context context) {
        this.item = item;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
		View v= LayoutInflater.from(context).inflate(R.layout.paperyearlist,   parent,false);
		final AdaperPaperYear.ViewHolder viewHolder=new AdaperPaperYear.ViewHolder(v);
        ...
        viewHolder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(checkInternet()==false)
                    ...
                    String opption =myFunction.getOpption();
                    final String year = item.get(viewHolder.getAdapterPosition()).getYear();
                    StorageReference storageRef = FirebaseStorage.getInstance().getReference().child(Year).child(branch).child(opption).child(subname + year);
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
       PaperTable listItem =item.get(position);
        holder.t1.setText("Sub  :"+listItem.getNameofsub());
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            super(itemView);
            t1 = (TextView) itemView.findViewById(R.id.subjectName1);
            t2 = (TextView) itemView.findViewById(R.id.year1);
        }
    }
}
